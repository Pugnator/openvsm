...
static const lua_bind_func lua_c_api_list[] =
{
	...
	{.lua_func_name="clear_bit", .lua_c_api=&lua_clear_bit, .args={}},
	{.lua_func_name="toggle_bit", .lua_c_api=&lua_toggle_bit, .args={}},
	{.lua_func_name="systime", .lua_c_api=&lua_get_systime, .args={}},
	{ NULL, NULL},
};
